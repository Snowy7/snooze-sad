...
const CTASection = dynamic(() => import("@/components/marketing/cta-section").then(mod => mod.CTASection));
const InteractivePreview = dynamic(() => import("@/components/marketing/interactive-preview").then(mod => mod.InteractivePreview));
