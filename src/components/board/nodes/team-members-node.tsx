...
export function TeamMembersNode({ data, selected }: NodeProps) {
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4 flex-shrink-0">
          ...
          <div className="flex items-center gap-1">
            {currentWorkspaceId && (
              <Link href={`/workspaces/${currentWorkspaceId}/settings?tab=members`} onClick={(e) => e.stopPropagation()}>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent onClick={(e) => e.stopPropagation()}>
                <AlertDialogHeader>
                  <AlertDialogTitle>Delete team members?</AlertDialogTitle>
                  <AlertDialogDescription>
              ...
              {members.map((member) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center font-semibold text-primary flex-shrink-0">
